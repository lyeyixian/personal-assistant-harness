"""The Typst compile seam: a fixture `ResumeContent` compiled through the real
...
from assistant.modules.render.models import ResumeBullet, ResumeExperience
from assistant.modules.render.pdf import TEMPLATE_PATH, ResumeOverflowError, render_resume_pdf
from tests.modules.render._helpers import make_resume_content
